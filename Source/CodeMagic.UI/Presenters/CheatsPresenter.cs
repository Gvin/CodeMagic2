...
namespace CodeMagic.UI.Presenters
{
    ...
    public class CheatsPresenter : IPresenter
    {
        ...
        {
            _logger.LogInformation("Used Cheat {CheatName}", "Restore Stats");
            _view.Close();
        ...
        {
            _logger.LogInformation("Used Cheat {CheatName}", "Restore Stamina");
            _view.Close();
            ((Player)CurrentGame.Player).Stamina = ((Player)CurrentGame.Player).MaxStamina;
        }
        ...
        {
            _logger.LogInformation("Used Cheat {CheatName}", "Restore Mana");
            _view.Close();
            CurrentGame.Player.Mana = CurrentGame.Player.MaxMana;
        }
        ...
        {
            _logger.LogInformation("Used Cheat {CheatName}", "Heal");
            _view.Close();
            CurrentGame.Player.Health = CurrentGame.Player.MaxHealth;
        }
        ...
        {
            _logger.LogInformation("Used Cheat {CheatName}", "Level Up");
            _view.Close();
